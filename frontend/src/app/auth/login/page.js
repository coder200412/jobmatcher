      ...
      <div className="auth-card" id="login-card">
        ...
        <div style={{ background: 'var(--bg-glass)', borderRadius: 'var(--radius-md)', padding: 'var(--space-md)', marginBottom: 'var(--space-md)' }}>
          ...
          <div className="flex flex-wrap gap-xs">
            <button className="btn btn-ghost btn-sm" onClick={() => setForm({ email: 'alice@demo.com', password: 'password123' })}>
              👩‍💻 Alice (Candidate)
            </button>
            <button className="btn btn-ghost btn-sm" onClick={() => setForm({ email: 'recruiter1@demo.com', password: 'password123' })}>
              👔 Sarah (Recruiter)
            </button>
          </div>
        </div>
